...
このモジュールには、NFT 発行に必要な標準機能が含まれているため、開発者は独自のロジックを記述してカスタマイズするところに集中できます。
...
上記の `Tanya` の JSON メタデータをコピーして、 [こちら]([https://jsonkeeper.com/](https://www.npoint.io/) の Web サイトに貼り付けてください。
